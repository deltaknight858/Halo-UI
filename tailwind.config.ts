  ...
  theme: {
  	extend: {
  		...
  		colors: {
  			...
  			// Halo UI color mappings using CSS variables
  			halo: {
  				bg: 'rgb(var(--halo-bg) / <alpha-value>)',
  				'bg-elev': 'rgb(var(--halo-bg-elev) / <alpha-value>)',
  				fg: 'rgb(var(--halo-fg) / <alpha-value>)',
  				muted: 'rgb(var(--halo-muted) / <alpha-value>)',
  				primary: 'rgb(var(--halo-primary) / <alpha-value>)',
  		...
  		borderRadius: {
  			...
  			// Halo radius mappings
  			halo: 'var(--halo-radius)',
  			'halo-sm': 'calc(var(--halo-radius) * 0.5)',
  			'halo-lg': 'calc(var(--halo-radius) * 1.5)',
  		},
  		keyframes: {
  			'accordion-down': {
  				from: {
